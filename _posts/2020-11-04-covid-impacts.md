...
![Q1]({{site.baseurl}}/{{page.folder}}/q1.jpg){:class="img-fluid" width="80%"}
...
![Q2]({{site.baseurl}}/{{page.folder}}/q2.jpg){:class="img-fluid" width="80%"}
...
![Q3]({{site.baseurl}}/{{page.folder}}/q3.jpg){:class="img-fluid" width="80%"}
...
![Q4]({{site.baseurl}}/{{page.folder}}/q4.jpg){:class="img-fluid" width="80%"}
...
![Q5]({{site.baseurl}}/{{page.folder}}/q5.jpg){:class="img-fluid" width="80%"}
...
![Q6]({{site.baseurl}}/{{page.folder}}/q6.jpg){:class="img-fluid" width="80%"}
